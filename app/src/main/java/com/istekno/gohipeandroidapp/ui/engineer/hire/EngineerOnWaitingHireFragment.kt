package com.istekno.gohipeandroidapp.ui.engineer.hire
...
class EngineerOnWaitingHireFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_engineer_on_waiting_hire, container, false)
        return binding.root
    }
    ...
    private fun getHire() {
        ...
        coroutineScope.launch {
            ...
            binding.pgHireengfrgA.visibility = View.VISIBLE
