package com.istekno.gohipeandroidapp.ui.engineer.account
...
import com.istekno.gohipeandroidapp.ui.adapter.EngineerProfileViewPagerAdapter
import com.istekno.gohipeandroidapp.databinding.FragmentEngineerAccountScreenBinding
import com.istekno.gohipeandroidapp.ui.engineer.favorite.EngineerFavoriteScreenFragment
        ...
        coroutineScope.launch {
            ...
            if (result is EngineerGetByIDResponse) {
                ...
                Glide.with(view.context)
                    .load(imageLink + result.database[0].enAvatar)
                    .apply(
                        RequestOptions.placeholderOf(R.drawable.ic_loading)
                        .error(R.drawable.ic_error))
                    .into(binding.imgEnaccfrgAvatar)
